...
class GoNeuralNetwork():
    ...
    def build_network(self, scope_name):
        ...
        with tf.variable_scope(scope_name):
            ...
            # Conv Layers
            conv = ops.conv_layer(self.network_inputs[scope_name], filters, kernel_size, stride, activation, "conv1",
                                  useBatchNorm, drop_out, self.is_train)
            ...
            value_out = ops.basic_layer(value_conv, weights["value"], biases["value"], activation, False, drop_out,
                                        self.is_train)
